...
class LaPizarra extends StatefulWidget {
  final VoidCallback onBack;

  const LaPizarra({super.key, required this.onBack});

  @override
  State<LaPizarra> createState() => _LaPizarraState();
}

class _LaPizarraState extends State<LaPizarra> {
  ...
  void _setupWebView() {
    ...
    final platformController =
        WebViewController()
          ...
          ..loadRequest(
            Uri.parse(
              'https://www.youtube.com/watch?v=VH0g5xg3QIM&list=PL1GsrUqNhGM9SwyPtV8_4zYmLW31g5i-G',
            ),
          );
