...
class ComexTuVoz extends StatefulWidget {
  final VoidCallback onBack;

  const ComexTuVoz({super.key, required this.onBack});

  @override
  State<ComexTuVoz> createState() => _ComexTuVozState();
}

class _ComexTuVozState extends State<ComexTuVoz> {
  ...
  void _setupWebView() {
    ...
    final platformController =
        WebViewController()
          ...
          ..loadRequest(
            Uri.parse(
              'https://www.youtube.com/watch?v=F4tovwXuLEo&list=PL1GsrUqNhGM9OkGAjtKq3dxqEZSQOmAsw&pp=0gcJCV8EOCosWNin',
            ),
          );
