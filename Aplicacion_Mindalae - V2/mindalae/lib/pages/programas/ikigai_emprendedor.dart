...
class IkigaiEmprendedor extends StatefulWidget {
  final VoidCallback onBack;

  const IkigaiEmprendedor({super.key, required this.onBack});

  @override
  State<IkigaiEmprendedor> createState() => _IkigaiEmprendedorState();
}

class _IkigaiEmprendedorState extends State<IkigaiEmprendedor> {
  ...
  void _setupWebView() {
    ...
    final platformController =
        WebViewController()
          ...
          ..loadRequest(
            Uri.parse(
              'https://www.youtube.com/watch?v=hG1-KVbySTc&list=PL1GsrUqNhGM-QiHf8CCKI_QraOixF_M1o',
            ),
          );
