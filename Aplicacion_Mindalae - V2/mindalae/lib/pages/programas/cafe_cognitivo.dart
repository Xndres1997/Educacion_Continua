...
class CafeCognitivo extends StatefulWidget {
  final VoidCallback onBack;

  const CafeCognitivo({super.key, required this.onBack});

  @override
  State<CafeCognitivo> createState() => _CafeCognitivoState();
}

class _CafeCognitivoState extends State<CafeCognitivo> {
  ...
  void _setupWebView() {
    ...
    final platformController =
        WebViewController()
          ...
          ..loadRequest(
            Uri.parse(
              'https://www.youtube.com/watch?v=Zh6TpJkfnrQ&list=PL1GsrUqNhGM-t93AU0rQnlcA_z6QS3Xnk',
            ),
          );
